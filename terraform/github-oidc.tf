      ...
      Condition = {
        ...
        StringLike = {
          "token.actions.githubusercontent.com:sub" = [
            "repo:opestyle/employee-app:*",
            "repo:LandmakTechnology/employee-app:*"
          ]
        }
      }
    }]
...
# Allow reading/writing Terraform state in S3 + DynamoDB locking
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:dynamodb:${var.region}:*:table/landmark-terraform-locks"
      }
    ]
  })
}
